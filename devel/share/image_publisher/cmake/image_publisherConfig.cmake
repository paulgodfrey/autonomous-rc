...
if("TRUE" STREQUAL "TRUE")
  set(image_publisher_SOURCE_PREFIX /home/nvidia/autonomous-rc/src/image_pipeline/image_publisher)
  set(image_publisher_DEVEL_PREFIX /home/nvidia/autonomous-rc/devel)
  ...
  set(image_publisher_INSTALL_PREFIX /home/nvidia/autonomous-rc/install)
...
if(NOT "/home/nvidia/autonomous-rc/devel/include " STREQUAL " ")
  set(image_publisher_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/autonomous-rc/devel/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'image_publisher' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/autonomous-rc/src/image_pipeline/image_publisher/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
