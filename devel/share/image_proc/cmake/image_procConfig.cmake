...
if("TRUE" STREQUAL "TRUE")
  set(image_proc_SOURCE_PREFIX /home/nvidia/autonomous-rc/src/image_pipeline/image_proc)
  set(image_proc_DEVEL_PREFIX /home/nvidia/autonomous-rc/devel)
  ...
  set(image_proc_INSTALL_PREFIX /home/nvidia/autonomous-rc/install)
...
if(NOT "/home/nvidia/autonomous-rc/devel/include;/home/nvidia/autonomous-rc/src/image_pipeline/image_proc/include;/usr/include/opencv;/usr/include " STREQUAL " ")
  set(image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/autonomous-rc/devel/include;/home/nvidia/autonomous-rc/src/image_pipeline/image_proc/include;/usr/include/opencv;/usr/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/autonomous-rc/src/image_pipeline/image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
    _list_append_unique(image_proc_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "image_proc;/usr/lib/libopencv_vstab.so.2.4.13;/usr/lib/libopencv_tegra.so.2.4.13;/usr/lib/libopencv_imuvstab.so.2.4.13;/usr/lib/libopencv_facedetect.so.2.4.13;/usr/lib/libopencv_esm_panorama.so.2.4.13;/usr/lib/libopencv_detection_based_tracker.so.2.4.13;/usr/lib/libopencv_videostab.so.2.4.13;/usr/lib/libopencv_video.so.2.4.13;/usr/lib/libopencv_superres.so.2.4.13;/usr/lib/libopencv_stitching.so.2.4.13;/usr/lib/libopencv_photo.so.2.4.13;/usr/lib/libopencv_objdetect.so.2.4.13;/usr/lib/libopencv_ml.so.2.4.13;/usr/lib/libopencv_legacy.so.2.4.13;/usr/lib/libopencv_imgproc.so.2.4.13;/usr/lib/libopencv_highgui.so.2.4.13;/usr/lib/libopencv_gpu.so.2.4.13;/usr/lib/libopencv_flann.so.2.4.13;/usr/lib/libopencv_features2d.so.2.4.13;/usr/lib/libopencv_core.so.2.4.13;/usr/lib/libopencv_contrib.so.2.4.13;/usr/lib/libopencv_calib3d.so.2.4.13")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/nvidia/autonomous-rc/devel/lib;/home/nvidia/autonomous-rc/devel/lib;/opt/ros/kinetic/lib)
