...
if("TRUE" STREQUAL "TRUE")
  set(vesc_driver_SOURCE_PREFIX /home/nvidia/autonomous-rc/src/vesc/vesc_driver)
  set(vesc_driver_DEVEL_PREFIX /home/nvidia/autonomous-rc/devel)
  ...
  set(vesc_driver_INSTALL_PREFIX /home/nvidia/autonomous-rc/install)
...
if(NOT "/home/nvidia/autonomous-rc/src/vesc/vesc_driver/include " STREQUAL " ")
  set(vesc_driver_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/autonomous-rc/src/vesc/vesc_driver/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_driver' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/autonomous-rc/src/vesc/vesc_driver/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
