...
if("TRUE" STREQUAL "TRUE")
  set(stereo_image_proc_SOURCE_PREFIX /home/nvidia/autonomous-rc/src/image_pipeline/stereo_image_proc)
  set(stereo_image_proc_DEVEL_PREFIX /home/nvidia/autonomous-rc/devel)
  ...
  set(stereo_image_proc_INSTALL_PREFIX /home/nvidia/autonomous-rc/install)
...
if(NOT "/home/nvidia/autonomous-rc/devel/include;/home/nvidia/autonomous-rc/src/image_pipeline/stereo_image_proc/include " STREQUAL " ")
  set(stereo_image_proc_INCLUDE_DIRS "")
  set(_include_dirs "/home/nvidia/autonomous-rc/devel/include;/home/nvidia/autonomous-rc/src/image_pipeline/stereo_image_proc/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'stereo_image_proc' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/autonomous-rc/src/image_pipeline/stereo_image_proc/${idir}'.  Ask the maintainer 'Vincent Rabaud <vincent.rabaud@gmail.com>' to fix it.")
    endif()
