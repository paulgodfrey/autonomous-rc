...
if("TRUE" STREQUAL "TRUE")
  set(vesc_msgs_SOURCE_PREFIX /home/nvidia/autonomous-rc/src/vesc/vesc_msgs)
  set(vesc_msgs_DEVEL_PREFIX /home/nvidia/autonomous-rc/devel)
  ...
  set(vesc_msgs_INSTALL_PREFIX /home/nvidia/autonomous-rc/install)
...
if(NOT "/home/nvidia/autonomous-rc/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'vesc_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/nvidia/autonomous-rc/src/vesc/vesc_msgs/${idir}'.  Ask the maintainer 'Michael T. Boulet <boulet@ll.mit.edu>' to fix it.")
    endif()
